                ...
                <div className='mt-5 justify-between gap-8 md:flex'>
                    <motion.div className='mt-10 basis-3/5 md:mt-0'
                     ...
                     variants={{
                        ...
                        <form target='_blank' onSubmit={onSubmit} action='https://formsubmit.co/fsahla370@gmail.com' method='POST'>
                            ...
                            {errors.name && (
                                <p className='mt-1 text-primary-500'>
                                    ...
                                    {errors.name.type === "maxLength" && "Atleast 28 character is needed"}
                                </p>
                            )}
                            ...
                            {errors.email && (
                                <p className='mt-1 text-primary-500'>
                                    ...
                                    {errors.email.type === "pattern" && "email is not available"}
                                </p>
                            )}
                            ...
                            {errors.message && (
                                <p className='mt-1 text-primary-500'>
                                    ...
                                    {errors.message.type === "maxLength" && "Atleast 2000 character is needed"}
                                </p>
                            )}
